{
  ...
  options.opts.theme = {
    ...
    in {
      ...
      brightRed = mkColorOption "f38ba8";
      yellow = mkColorOption "f9e2af";
      brightYellow = mkColorOption "f9e2af";
      green = mkColorOption "a6e3a1";
      brightGreen = mkColorOption "a6e3a1";
      cyan = mkColorOption "94e2d5";
      brightCyan = mkColorOption "94e2d5";
      blue = mkColorOption "89b4fa";
      brightBlue = mkColorOption "89b4fa";
      magenta = mkColorOption "cba6f7";
      brightMagenta = mkColorOption "cba6f7";
      black = mkColorOption "f5c2e7";
      brightBlack = mkColorOption "f5c2e7";
      white = mkColorOption "f5c2e7";
      brightWhite = mkColorOption "f5c2e7";
    };
